...
public class SecurityConfig {
	...
	/**
	 * Configura o JwtDecoder utilizando chave simétrica (HMAC SHA-256). A chave é
	 * lida do application.properties e decodificada em Base64.
	 */
	@Bean
	 ...
	 * Define política de sessão como STATELESS. - Permite requisições OPTIONS
	 * (necessárias para CORS). - Libera acesso às rotas públicas configuradas. -
	 * Exige autenticação para todas as demais requisições. - Configura a aplicação
	 * como Resource Server com suporte a JWT.
	 */
	@Bean
