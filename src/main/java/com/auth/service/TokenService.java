...
/**
 * Serviço responsável pela geração de tokens JWT assinados
 * utilizando algoritmo HMAC SHA-256.
 *
 * Esta classe é independente de framework web e pode ser
 * utilizada em qualquer aplicação Java.
 */
public class TokenService {
    ...
    public String gerarToken(Map<String, String> usuario, long expiracaoSegundos) {
        ...
        var builder = JWT.create()
                .withIssuer("http://authtokenservice")
                .withSubject(usuario.get("usuario"))
